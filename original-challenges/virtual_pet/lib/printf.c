...
size_t cgc_transmit_char(char d);
size_t cgc_transmit_unsigned(unsigned int value);
size_t cgc_transmit_string(char *string);

size_t cgc_printf(const char *format, ...) {
    cgc_va_list ap;
    size_t count = 0;
